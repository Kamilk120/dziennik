...
(3, 'namef', 'surname ', 'fsd@wp.pl', 'dfs', 11),
(6, 'kamil', 'kubik', 'kamilk120@wp.pl', 'lol', NULL),
(7, 'kamil', 'kubik', 'fsdd@wp.pl', 'liga', NULL);
...
--
ALTER TABLE `administration`
  ADD CONSTRAINT `administration_ibfk_1` FOREIGN KEY (`id_industry`) REFERENCES `industry` (`name_industry`) ON UPDATE SET NULL ON DELETE SET NULL;

--
-- Ograniczenia dla tabeli `class`
--
ALTER TABLE `class`
  ADD CONSTRAINT `class_ibfk_1` FOREIGN KEY (`id_industry`) REFERENCES `industry` (`name_industry`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `class_ibfk_2` FOREIGN KEY (`opiekun`) REFERENCES `administration` (`id_person`) ON UPDATE SET NULL ON DELETE SET NULL;

--
-- Ograniczenia dla tabeli `day_leson`
--
ALTER TABLE `day_leson`
  ADD CONSTRAINT `day_leson_ibfk_1` FOREIGN KEY (`id_class`) REFERENCES `class` (`id_class`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `day_leson_ibfk_2` FOREIGN KEY (`id_subject`) REFERENCES `subject` (`id_subject`) ON UPDATE SET NULL ON DELETE SET NULL;

--
-- Ograniczenia dla tabeli `marks`
--
ALTER TABLE `marks`
  ADD CONSTRAINT `marks_ibfk_1` FOREIGN KEY (`id_student`) REFERENCES `students` (`id_student`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `marks_ibfk_2` FOREIGN KEY (`id_subject`) REFERENCES `subject` (`id_subject`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `marks_ibfk_3` FOREIGN KEY (`id_teacher`) REFERENCES `administration` (`id_person`) ON UPDATE SET NULL ON DELETE SET NULL;

--
-- Ograniczenia dla tabeli `obiections`
--
ALTER TABLE `obiections`
  ADD CONSTRAINT `obiections_ibfk_1` FOREIGN KEY (`id_student`) REFERENCES `students` (`id_student`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `obiections_ibfk_2` FOREIGN KEY (`id_person`) REFERENCES `administration` (`id_person`) ON UPDATE SET NULL ON DELETE SET NULL;
...
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_ibfk_1` FOREIGN KEY (`id_class`) REFERENCES `class` (`id_class`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `students_ibfk_2` FOREIGN KEY (`id_class`) REFERENCES `class` (`id_class`) ON UPDATE SET NULL ON DELETE SET NULL;

--
-- Ograniczenia dla tabeli `subject`
--
ALTER TABLE `subject`
  ADD CONSTRAINT `subject_ibfk_1` FOREIGN KEY (`id_teacher`) REFERENCES `administration` (`id_person`) ON UPDATE SET NULL ON DELETE SET NULL,
  ADD CONSTRAINT `subject_ibfk_2` FOREIGN KEY (`id_industry`) REFERENCES `industry` (`name_industry`) ON UPDATE SET NULL ON DELETE SET NULL;
COMMIT;
