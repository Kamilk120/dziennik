...
--
-- Host: 127.0.0.1
-- Czas generowania: 22 Paź 2022, 18:43
...
--
-- Ograniczenia dla tabeli `industry`
--
ALTER TABLE `industry`
  ADD CONSTRAINT `industry_ibfk_1` FOREIGN KEY (`head_teacher_id`) REFERENCES `administration` (`id_person`);
